...
The cumulative contributions of this work are summarised below:

1. A reproducible, statistically rigorous evaluation pipeline for the APTOS 2019 dataset, with stratified splits, architecture-specific preprocessing, balanced class weighting, and unified training callbacks.
...
**Kreu IV** reports and discusses the experimental results, organised in three phases: binary baselines and calibration; conformal prediction, MC Dropout, K-fold cross-validation and OOD detection; and the multi-class severity grading reformulation.

**Kreu V** concludes with a summary of contributions, clinical implications, limitations, and avenues for future work.
